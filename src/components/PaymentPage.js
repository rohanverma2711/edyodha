    ...
    <>
      <div className="paymentPage">
        <div className="leftContent">
          <div className="leftContentHead">Access curated courses worth</div>
          <div style={{ justifyContent: "flex-start" }}>
            <img
              style={{ marginRight: "150px" }}
              height={"70px"}
              width={"630px"}
              src={Resources.images.frame1}
            ></img>
          </div>
          <div className="LeftBody">
            <div className="features">
              ...
              <div className="Featuresright">
                ...
                <p className="whiteText" style={{ marginLeft: "10px" }}>
                  {" "}
            ...
            <div className="features">
              ...
              <div className="Featuresright">
                ...
                <p className="blueFeature" style={{ marginLeft: "10px" }}>
                  {" "}
                  &#x20B9;94,000{" "}
                </p>
              </div>
        ...
        <div className="rightContent">
          <div className="paymentSection">
            <div className="TopHeader">
              ...
              <div className="CircleText">
                <div className="circle">
                  <img src={Resources.images.circle2}></img>
                </div>
                <div> Subscribe</div>
              </div>
            </div>
            ...
            <div className="PaymentOption1">
              <div className="offerHighlighter">Offer Expired</div>
            ...
            {mockdata.map((mock) => (
              <div
                className={
                  clickedIndex === mock.id
                    ? "paymentIsClicked"
                    : "PaymentOption2"
                }
                key={mock.id}
                onClick={() => handleClick(mock.price, mock.id)}
              >
                {mock.isRecommended ? (
                  <div className="offerHighlighter2">Recommended</div>
                ) : (
